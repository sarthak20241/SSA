...
def monte_carlo_collision_probability(states_1_ca, cov_matrix_1_ca, states_2_ca, cov_matrix_2_ca, num_samples=100000, collision_threshold=50.0*u.m):
   
    # Sample from the error distributions
    error_samples_1 = np.random.multivariate_normal([0, 0, 0], cov_matrix_1_ca, size=num_samples)*0.1*u.km
    error_samples_2 = np.random.multivariate_normal([0, 0, 0], cov_matrix_2_ca, size=num_samples) *0.1*u.km
    # print("error samples")
